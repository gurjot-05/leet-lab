...
import { getJudge0LanguageId } from "../lib/utils.js";
...
const ProblemPage = () => {
  ...
  console.log("Submissions:", JSON.stringify(singleSubmission));
  ...
  const { submission, executeCode, IsExecuting, time, memory, status } =
    useExecutionStore();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-300 to-base-200 pt-16">
