              ...
              <div className="dropdown dropdown-end">
                <button tabIndex={0} className="btn btn-secondary gap-2">
                  ...
                  <svg
                    ...
                    viewBox="0 0 20 20"
                  >
                    <path d="M5.25 6.25L10 11l4.75-4.75L16 7.25l-6 6-6-6z" />
                  </svg>
                </button>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="card bg-base-100 shadow-md">
                      <div className="card-body p-4 md:p-6">
                        ...
                        <div className="border rounded-md overflow-hidden">
                          <Controller
                            name={`referrenceSolutions.${language}`}
                            control={control}
                            render={({ field }) => (
                              <Editor
                                height="300px"
                        ...
                        {errors.referrenceSolutions?.[language] && (
                          <div className="mt-2">
                            <span className="text-error text-sm">
                              {errors.referrenceSolutions[language].message}
                            </span>
                          </div>
                        )}
                      </div>
